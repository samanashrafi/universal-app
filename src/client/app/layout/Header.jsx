    ...
    return (
      <header >
        <div className="container-center">
          ...
          <div id="hamburger-menu" className="hamburger hamburger--arrow-r" onClick={this.sideMenu}>
          ...
          <ul className="overley" >
            ...
            <li>
              <Link to="/partner">درخواست همکاری</Link>
            </li>
            <li>
              <Link to="/aboutme"> درباره الو کلاس</Link>
            </li>
            <li>
