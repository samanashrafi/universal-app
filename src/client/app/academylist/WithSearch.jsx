    ...
    onSubmit(e){
      ...
      if(this.refs.searchFilter.value.length == 0){
        ...
        if(this.refs.searchFilter.value.length > 2){
            ...
            this.props.getAcademyList(this.filterText(this.refs.searchFilter.value));
        ...
        <div className="container-center">
          <form className="filter" onSubmit={this.onSubmit}>
            <div className="form-select">
              <input
                type="search"
                ref="searchFilter" value={this.state.q} onChange={this.searchFilter}
...
const FinalSearch = compose(
    connect(mapStateToProps,{getAcademyList}),
    WithSearch
);
